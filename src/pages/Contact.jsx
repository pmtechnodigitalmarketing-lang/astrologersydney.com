...
const contactFaqs = [
  {
    ...
    answer:
      "We strive to respond to all inquiries within 24 hours during normal business days. If you reach out on a weekend, we will get back to you on Monday.",
  },
  {
    question: "Do you take emergency bookings?",
    answer:
      "Yes, we hold a few emergency slots each week for urgent spiritual crises (such as sudden demonic oppression or acute anxiety). Please call our phone number directly for emergencies.",
  },
  {
    question: "Can I talk to someone before booking?",
    answer:
      "Absolutely. We offer a brief 10-minute discovery call free of charge to ensure our services are the right fit for your specific spiritual needs.",
  },
];
...
const Contact = () => {
  ...
  return (
    <div className="contact-page">
        ...
        <section className="contact-hero">
          ...
          >
            ...
            <h1 className="contact-hero-title">
              CONNECT WITH
              <br />
              <span className="italic">Our Guides</span> FOR CLARITY,
              <br />
              HEALING, AND <span className="highlight">SUPPORT.</span>
            </h1>
            <p className="contact-hero-subtitle">
              Ready for your session? Connect with our spiritual guides to
              schedule your private consultation or ask any questions.
            </p>
          </motion.div>
        </section>
        ...
        <div className="contact-content">
          ...
          >
            <div className="contact-form-info">
              ...
              <p>
                Whether you're seeking clarity on your birth chart, looking for
                relationship guidance, or need immediate spiritual support, our
                highly attuned astrologers are here to help you navigate life's
                cosmic journey.
              </p>
              ...
              <div className="contact-benefits-list">
                <div className="contact-benefit-item">
                  ...
                  <p>
                    <strong>100% Confidential:</strong> Your spiritual journey
                    and personal details are always kept entirely private.
                  </p>
                </div>
                <div className="contact-benefit-item">
                  <span className="material-symbols-outlined benefit-icon">
                  ...
                  <p>
                    <strong>Rapid Response:</strong> Our guides review inquiries
                    daily to provide timely cosmic guidance.
                  </p>
                </div>
                <div className="contact-benefit-item">
                  <span className="material-symbols-outlined benefit-icon">
                  ...
                  <p>
                    <strong>Personalized Care:</strong> Every consultation is
                    tailored to your unique astrological blueprint.
                  </p>
                </div>
              </div>
            ...
            <div className="contact-form-wrapper">
              {isSubmitted ? (
                ...
                >
                  ...
                  <p>
                    Thank you for reaching out to Soul Astrology Centre. Our
                    guides have received your message and will reply to your
                    earthly inbox shortly.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="premium-form">
                  ...
                  <div
                    ...
                    style={{ zIndex: dropdownOpen ? 100 : 2 }}
                  >
      ...
      <div
        className="container contact-faq-container"
        style={{ marginTop: "6rem" }}
      >
        <FAQ
          data={contactFaqs}
          title="Booking & Support FAQ"
          subtitle="Answers about contacting us and scheduling."
        />
      </div>
    </div>
  );
